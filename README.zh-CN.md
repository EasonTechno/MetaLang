...
> **道爷我成了**：a = [-B ± √(B²-4AC)]/2A，需要 √(...) 为整数。你为什么要这么对我，我的数学又挂科了，我的心真的好痛啊啊啊啊啊啊！苍羌蹬阶！！！😅
> 
> 千万别让火子哥碰数学
...
> **何嘉豪**：知乎体回答，措辞讲究——"先固定 s 和 p，看能否凑出整数 a，b，c，谢邀但是这破题不是高中的么，上大学了还在追我"
> 
> 昵称正确我要这个
...
| 昵称 | 字数 | 回答亮点 |
|------|------|---------|
| **噬菌体侵染降噪耳机** | 108 | 参数化方法，尝试多种角度 |
| **数学数学我们喜欢你** | 114 | c=0枚举因子，完整分析直觉 |
| **道爷我成了** | 202 | 二次方程视角，过程详细 |
| **注意力惊人** | 185 | 列出全部12种因子对逐一验证 |
| **parity-police** | 182 | 模2分析排除多种情况 |
| **杀死那个贝尔曼代数线形几何微分几何啊啊啊** | 170 | 多项式构造思路 |
| **何嘉豪** | 172 | 三次方程视角分析根 |
| **今天晚上吃点啥** | 168 | 发现立方结构(a=b=1) |
| **KeYanZhao** | 87 | 对称性分析 |
| **IAKIOI** | 20 | 朴素直觉 |
